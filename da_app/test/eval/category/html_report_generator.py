...
#     """ ... (rest of generate_html_report function - Threshold tables, Metric Definitions, Box Color Definitions, Date/Author/Model Version etc.) ... """
...
#         """ ... (Threshold value table, message_box_color, message_metric_definition - as before) ... """
#         message='''
#         <html>
#         <head>
#             <style>
...
#             f_html.write(f"<td><a href='{item.get('image_path', '')}'><img src='{item.get('image_path', '')}' width='200'></a></td>") # Adjust width as needed
#             f_html.write("</tr>")
