...
typedef struct yolo11_app_context_t { // <-- Renamed
...
int init_yolo11(const char* model_path, yolo11_app_context_t* app_ctx); // <-- Renamed

int release_yolo11(yolo11_app_context_t* app_ctx); // <-- Renamed

int inference_yolo11(yolo11_app_context_t* app_ctx, // <-- Renamed
                     image_buffer_t* img,
