...
import 'package:groom/data_models/rating_model.dart';
...
class _ProviderDisplayScreenState extends State<ProviderDisplayScreen> {
  ...
  RatingsFirebase ratingsFirebase = RatingsFirebase();
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  scrollDirection: Axis.horizontal,
                  itemCount: providerServiceState.selectedProvider.value
                      .providerUserModel!.providerImages!.length,
                  itemBuilder: (context, index) {
                    String image = providerServiceState.selectedProvider.value
                        .providerUserModel!.providerImages![index];
                    return Card(
                      child: CachedNetworkImage(
                        fit: BoxFit.fill,
                        width: 120,
            ...
            SizedBox(
              ...
              width: MediaQuery.sizeOf(context).width,
              child: FutureBuilder(
                future: ratingsFirebase.getRatingsByProviderId(
                    providerServiceState.selectedProvider.value.uid),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    var ratings = snapshot.data as List<RatingModel>;
                    return ListView.builder(
                      scrollDirection: Axis.horizontal,
                    ...
                    ? GestureDetector(
                        onTap: () {
                          Get.to(() => ChatDetailScreen(
                                ...
                                friendId: providerServiceState
                                    .selectedProvider.value.uid,
                              ));
                        },
                        child: CircleAvatar(
                          radius: 30,
