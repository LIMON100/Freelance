...
int main(int argc, char *argv[]) {
    ...
    // --- NEW: Media Factory for /cam2 (using /dev/video2) ---
    // Make sure /dev/video2 exists on your system, or change it to the correct device.
    ...
    std::cout << "SERVER: Stream ready at rtsp://<your_ip>:8554/cam2" << std::endl;
