...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _switchCamera(int index) async {
    ...
    // The magic happens here. By changing the state and giving the
    // AndroidView a new UniqueKey, we are telling Flutter to
    // completely dispose of the old native view and create a brand new one.
    // The new view will then run its own `_onGStreamerPlatformViewCreated`
