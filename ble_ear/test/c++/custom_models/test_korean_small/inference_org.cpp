...
int main(int argc, char* argv[]) {
    ...
    const std::string feature_extractor_model_path = "/home/limonubuntu/Work/Limon/other_task/ble_project/training/models/06_22/test_korean_small/models/feature_extractor.onnx";
    const std::string classifier_model_path = "/home/limonubuntu/Work/Limon/other_task/ble_project/training/models/06_22/test_korean_small/models/korean_command_classifier0715.onnx";
    const std::string label_path = "/home/limonubuntu/Work/Limon/other_task/ble_project/training/models/06_22/test_korean_small/models/labels.txt";
