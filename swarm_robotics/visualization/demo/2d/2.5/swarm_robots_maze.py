...
def main():
    ...
    # Robots start at bottom right
    # robots = [
    #     Robot("L", 1150, 850, is_leader=True),
    #     Robot("F1", 1100, 900),
    #     Robot("F2", 1200, 900),
    #     Robot("F3", 1050, 950),
    #     Robot("F4", 1250, 950)
    ...
    # Recreate the maze from the image
    walls = [
        # Outer Boundary
        ...
        # Maze Interior Walls (approximated from image)
        Wall(100, 100, 20, 300),
        Wall(100, 380, 250, 20),
        Wall(350, 100, 20, 200),
        Wall(200, 200, 150, 20),
