...
def main():
    ...
    walls = [
        Wall(0.0, 0, 256.0, 20),
        Wall(384.0, 0, 896.0, 20),
        Wall(256.0, 130.0, 256.0, 20),
        Wall(640.0, 130.0, 256.0, 20),
        Wall(1152.0, 130.0, 128.0, 20),
        Wall(128.0, 270.0, 512.0, 20),
        Wall(896.0, 270.0, 256.0, 20),
        Wall(0.0, 410.0, 512.0, 20),
        Wall(768.0, 410.0, 128.0, 20),
        Wall(128.0, 550.0, 128.0, 20),
        Wall(384.0, 550.0, 384.0, 20),
        Wall(896.0, 550.0, 256.0, 20),
        Wall(256.0, 690.0, 128.0, 20),
        Wall(768.0, 690.0, 384.0, 20),
        Wall(128.0, 830.0, 128.0, 20),
        Wall(384.0, 830.0, 128.0, 20),
        Wall(640.0, 830.0, 128.0, 20),
        Wall(896.0, 830.0, 128.0, 20),
        Wall(0.0, 960, 384.0, 20),
        Wall(512.0, 960, 768.0, 20),
        Wall(0, 0.0, 20, 980.0),
        Wall(118.0, 0.0, 20, 280.0),
        Wall(118.0, 560.0, 20, 280.0),
        Wall(246.0, 700.0, 20, 140.0),
        Wall(374.0, 560.0, 20, 140.0),
        Wall(502.0, 0.0, 20, 140.0),
        Wall(502.0, 420.0, 20, 140.0),
        Wall(502.0, 700.0, 20, 280.0),
        Wall(630.0, 140.0, 20, 280.0),
        Wall(630.0, 700.0, 20, 140.0),
        Wall(758.0, 280.0, 20, 280.0),
        Wall(758.0, 700.0, 20, 140.0),
        Wall(886.0, 140.0, 20, 140.0),
        Wall(886.0, 420.0, 20, 140.0),
        Wall(1014.0, 140.0, 20, 280.0),
        Wall(1014.0, 840.0, 20, 140.0),
        Wall(1142.0, 420.0, 20, 420.0),
        Wall(1260, 0.0, 20, 980.0),
        ]
