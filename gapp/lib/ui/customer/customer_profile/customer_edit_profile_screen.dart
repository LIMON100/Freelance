...
//                               //     initialSelection: 'US',
//                               //     onChanged: (value) {
//                               //       _con.selectedCountry.value = value as String;
//                               //     },
//                               //   ),
//                               // ),
//                               // ),
...
//                                   decoration: BoxDecoration(
//                                     border: Border.all(
//                                         color: _con.selectedGender.value ==
//                                             "Other"
//                                             ? primaryColorCode
...
//                                     color: _con.selectedGender.value ==
//                                         "Other"
//                                         ? primaryColorCode.withOpacity(0.1)
//                                         : Colors.white,
//                                   ),
//                                   child: Row(
//                                     children: [
...
//                                             : Colors.black,
//                                       ),
//                                       if (_con.selectedGender.value == "Other")
//                                         const SizedBox(width: 5,),
//                                       if (_con.selectedGender.value == "Other")
//                                         Icon(Icons.check, color: primaryColorCode,size: 18,),
//                                     ],
//                                   ),
//                                 ),
//                                 onTap: () {
//                                   _con.selectedGender.value = "Other";
//                                 },
//                               ),
...
//                                             : Colors.black,
//                                       ),
//                                       if (_con.selectedGender.value == "Woman")
//                                         const SizedBox(width: 5,),
//                                       if (_con.selectedGender.value == "Woman")
//                                         Icon(Icons.check, color: primaryColorCode,size: 18,),
//                                     ],
...
//                                 ),
//                                 onTap: () {
//                                   _con.selectedGender.value = "Woman";
//                                 },
//                               ),
//                               const SizedBox(width: 10),
//                               InkWell(
...
//                                     borderRadius: const BorderRadius.all(
//                                         Radius.circular(10)),
//                                     color: _con.selectedGender.value == "Man"
//                                         ? primaryColorCode.withOpacity(0.1)
//                                         : Colors.white,
//                                   ),
//                                   child: Row(
...
//                                             : Colors.black,
//                                       ),
//                                       if (_con.selectedGender.value == "Man")
//                                         const SizedBox(width: 5,),
//                                       if (_con.selectedGender.value == "Man")
//                                         Icon(Icons.check, color: primaryColorCode,size: 18,),
//                                     ],
