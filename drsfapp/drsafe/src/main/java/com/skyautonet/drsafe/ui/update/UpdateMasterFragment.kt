 ...
 */
class UpdateMasterFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.updateLayout.btnUpdate.setOnClickListener {
            val bundle = Bundle()
            bundle.putString(Constants.EXTRA_TITLE, getString(R.string.firmware_update))
//            findNavController().navigate(R.id.action_updateMasterFragment_to_updateProgressFragment,bundle)
        }
