...
// const { StateGraph, MemorySaver, END } = require("@langchain/langgraph");
// const { ToolNode } = require("@langchain/langgraph/prebuilt");
// const { ChatOpenAI } = require("@langchain/openai");
// const { InMemoryStore } = require("@langchain/langgraph");
// const upsertMemoryTool = require("./tools/upsertMemoryTool");
// const { SYSTEM_PROMPT } = require("./prompts/prompts");
// const { ConfigurationAnnotation, ensureConfiguration } = require("./configuration/configuration");
// const allProductsTool = require("./tools/allProductsTool");
// const { loadMemory, saveMemory } = require("./memoryStorage");

// async function chatBot(humanMessage, prevMessages) {
...
//   async function storeMemory(state) {
//     const lastMessage = state.messages[state.messages.length - 1];
//     const toolCalls = lastMessage.tool_calls || [];
...
//   const finalState = await app.invoke({ messages: messages }, { configurable: { thread_id: "42", user_id: "42" } });
...
async function chatBot(humanMessage, prevMessages) {
  ...
  async function storeMemory(state, config) {
      const lastMessage = state.messages[state.messages.length - 1];
      const toolCalls = lastMessage.tool_calls || [];
